<?php namespace App\Http\Controllers;
	...
	class AdminBdRecordGroupController extends \crocodicstudio\crudbooster\controllers\CBController {
...
//dd($rg_name[0]->name);
			...
			$this->col[] = ["label"=>"Record Group","name"=>"rg_id","join"=>"record_group,name"];
			$this->col[] = ["label"=>"Basic Data","name"=>"bd_id","join"=>"basicdata,name"];

			$this->col[] = ["label"=>"Description","name"=>"description"];
		//	$this->col[] = ["label"=>"Active","name"=>"active"];
		//	$this->col[] = ["label"=>"Editor","name"=>"editor"];
			$this->col[] = ["label"=>"Updated","name"=>"updated"];
			...
			$this->form[] = ['label'=>'Record Group','name'=>'rg_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'record_group,name'];
			$this->form[] = ['label'=>'Basic Data','name'=>'bd_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'basicdata,name'];
		...
		//	$this->form[] = ['label'=>'Editor','name'=>'editor','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Rg Id","name"=>"rg_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"rg,id"];
			# OLD END FORM
	        ...
	        */
	        $this->sub_module = array();
				  $this->sub_module[] = ['label'=>' Record Group Details','path'=>'record_details28','foreign_key'=>'bd_rg_id','button_color'=>'primary','parent_columns'=>'description'];
