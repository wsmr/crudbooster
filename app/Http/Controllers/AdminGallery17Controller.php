<?php namespace App\Http\Controllers;
	...
	class AdminGallery17Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->col[] = ["label"=>"Album Id","name"=>"album_id","join"=>"album,id"];
			...
			// 							 ];
			$this->form[] = ['label'=>'Album Id','name'=>'album_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'album,name'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Album Id","name"=>"album_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"album,name"];
