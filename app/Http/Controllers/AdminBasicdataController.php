<?php namespace App\Http\Controllers;
	...
	class AdminBasicdataController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->col[] = ["label"=>"bd_type Id","name"=>"bdt_id","join"=>"bd_type,id"];
			...
			$this->form[] = ['label'=>'Basic Data Types','name'=>'bdt_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'bd_type,name'];
			...
			//$this->form[] = ["label"=>"Bdt Id","name"=>"bdt_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"bdt,id"];
	        ...
	        */
	        $this->sub_module = array();
					...
					//$this->sub_module[] = ['label'=>'Options','path'=>'bd_option','foreign_key'=>'bd_id','button_color'=>'primary','button_icon'=>'fa fa-tags','parent_columns'=>'name'];
					$this->sub_module[] = ['label'=>'Record Groups','path'=>'bd_record_group','foreign_key'=>'bd_id','button_color'=>'primary','button_icon'=>'fa fa-tags','parent_columns'=>'name'];
